...
z = np.array((5, 1, 4))#Miller indices

# the foil normal (also pointing into the image)
n = np.array((5, 1, 4))#Miller indices
...
# line direction
u = np.array((1, 0, -1))#Miller indices
...
Ib2= Ib#cv.GaussianBlur(Ib,(ker,ker),blursigma)
Id2= Id#cv.GaussianBlur(Id,(ker,ker),blursigma)
