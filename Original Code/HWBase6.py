...
n = np.array((1, 5, 6))#Miller indices
...
if use_cl:
    ...
    sxz1 = funcs_1.calculate_deviations(xsiz, zsiz, pix2nm, t, dt,
                                       u, g, b, c2d, nu, phi, psi, theta)
    Ib, Id = funcs_1.calculate_image(sxz1, xsiz, ysiz, zsiz, pix2nm, 
