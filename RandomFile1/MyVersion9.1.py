...
def gdotRdz(r, bscrew, bedge, beUnit, bxu, nu, gD, xsiz, zsiz, dz):
    gR = gdotR(r, bscrew, bedge, beUnit, bxu, nu, gD, xsiz, zsiz)
    r[...,1] += dz
    gRdz = gdotR(r, bscrew, bedge, beUnit, bxu, nu, gD, xsiz, zsiz)
    return (gRdz - gR)/dz
...
sxz = gdotRdz(rD,bscrew,bedge,beUnit, bxu, nu, gD,xsiz,zsiz,dz)
...
r = cp.transpose(cp.tile(cp.linspace(0,100000, 1000), [10,3,1]),[0,2,1])

rr = gdotRdz(r,bscrew,bedge,beUnit, bxu, nu, gD,10,100000-1,dz)
